public class Battle {
    ...
    public void fight(AbstractEntity hero, AbstractEntity monster, FightCallback fightCallback) {
        Runnable runnable = () -> {
    ...
    private Boolean makeHit(AbstractEntity defender, AbstractEntity attacker, FightCallback fightCallback) {
        //Получаем силу удара
